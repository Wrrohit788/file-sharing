...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7954936895:AAH2JIRk7PgJG5ZJwmzts9TkAslXCNovs3Q")

#Your API ID from my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "9680463"))

#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "abe7eef58121f62d19aa872a4510bbaf")

#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002569262484"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "7602378117"))
...
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1002540112625"))
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1002657840399"))
...
#start message
START_MSG = os.environ.get("START_MESSAGE", "<b>ʜᴇʟʟᴏ {first}\n\n ɪ ᴀᴍ ᴍᴜʟᴛɪ ғɪʟᴇ sᴛᴏʀᴇ ʙᴏᴛ , ɪ ᴄᴀɴ sᴛᴏʀᴇ ᴘʀɪᴠᴀᴛᴇ ғɪʟᴇs ɪɴ sᴘᴇᴄɪғɪᴇᴅ ᴄʜᴀɴɴᴇʟ ᴀɴᴅ ᴏᴛʜᴇʀ ᴜsᴇʀs ᴄᴀɴ ᴀᴄᴄᴇss ɪᴛ ғʀᴏᴍ sᴘᴇᴄɪᴀʟ ʟɪɴᴋ » @wrrohit02</b>")
try:
    ADMINS=[6695586027]
    for x in (os.environ.get("ADMINS", "7602378117").split()):
        ADMINS.append(int(x))
except ValueError:
